...
#include <sys/time.h>
#include "merc.h"
/*#include "act_godskills.h" lost this one - Ken */
...
const struct cmd_type cmd_table [] =
{
	...
	*/
	...
	{ "banish", do_ban, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	{ "siteban", do_ban, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	...
	{ "wizhelp", do_wizhelp, POS_DEAD, 95, LOG_NORMAL ,NULL},
	...
	*/
	...
	{ "search", do_search, POS_DEAD, 0, LOG_NORMAL ,NULL},
	...
	*/
	...
	{ "newchat", do_newchat, POS_SLEEPING, 0, LOG_NORMAL ,NULL},
	...
	{ "replylock", do_replylock, POS_DEAD, 0, LOG_NORMAL, NULL},
	{ "say", do_say, POS_RESTING, 0, LOG_NORMAL ,NULL},
	{ "'", do_say, POS_RESTING, 0, LOG_NORMAL ,NULL},
	{ "sing", do_sing, POS_RESTING, 0, LOG_NORMAL ,NULL},
	{ "shout", do_shout, POS_RESTING, 3, LOG_NORMAL ,NULL},
	{ "voice", do_voice, POS_RESTING, 0, LOG_ALWAYS ,NULL},
	{ "\\", do_channel_talk, POS_DEAD, 0, LOG_NORMAL, NULL},
	{ "talk", do_channel_talk, POS_DEAD, 0, LOG_NORMAL, NULL},
	{ "immtalk", do_immtalk, POS_SLEEPING, MAX_LEVEL-3, LOG_NORMAL, NULL},
	{ "godtalk", do_godtalk, POS_SLEEPING, MAX_LEVEL, LOG_NORMAL ,NULL},
	{ "invoke", do_reign, POS_SLEEPING, MAX_LEVEL, LOG_NORMAL ,NULL},
	{ "reign", do_reign, POS_SLEEPING, MAX_LEVEL, LOG_NORMAL ,NULL},
	{ "]", do_immtalk, POS_SLEEPING, MAX_LEVEL-3, LOG_NORMAL ,NULL},
	/*
	...
	*/
	...
	{ "battl", do_battl, POS_FIGHTING, 10, LOG_ALWAYS, NULL},
	{ "battle", do_battle, POS_FIGHTING, 10, LOG_ALWAYS, NULL},
	...
	/* { "protect", do_protect, POS_STANDING, 99, LOG_NEVER ,NULL}, */
	...
	{ "bodythrow", do_bodythrow, POS_FIGHTING, 0, LOG_NORMAL, NULL},
	...
	*/
	{ "riftmap", do_riftmap, POS_DEAD, 0, LOG_NORMAL, NULL},
	...
	{ "steal", do_steal, POS_STANDING, 0, LOG_ALWAYS ,NULL},
	...
	{ "tank", do_tank, POS_RESTING, 0, LOG_NORMAL ,NULL},

	/*
	* MOBprogram commands.
	*/
	{ "mpstat", do_mpstat, POS_DEAD, 99, LOG_NORMAL,NULL},
	...
	{ "mpjunkperson", do_mpjunk_person,POS_DEAD, MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "mpecho", do_mpecho, POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpechoat", do_mpechoat, POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpechoaround", do_mpechoaround,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpkill", do_mpkill ,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpmload", do_mpmload ,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpoload", do_mpoload ,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mppurge", do_mppurge ,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpmobpurge", do_mpmobpurge ,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpquiet", do_mpquiet ,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpgoto", do_mpgoto ,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpat", do_mpat ,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mptransfer", do_mptransfer ,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpforce", do_mpforce ,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpcheatlog", do_mpcheatlog, POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpmset", do_mpmset, POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mposet", do_mposet, POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpmadd", do_mpmadd, POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpoadd", do_mpoadd ,POS_DEAD, 99, LOG_NORMAL,NULL},
	{ "mpgorand", do_mpgorand ,POS_DEAD, 99, LOG_NORMAL,NULL},

	/*
	* Immortal commands.
	*/
	{ "fixvnum", do_fixvnum, POS_SLEEPING, MAX_LEVEL-2, LOG_ALWAYS, NULL},
	{ "questbits", do_questbits, POS_DEAD,MAX_LEVEL-3,LOG_ALWAYS ,NULL},
	{ "advance", do_advance, POS_DEAD,MAX_LEVEL, LOG_ALWAYS ,NULL},
	{ "trust", do_trust, POS_DEAD,MAX_LEVEL, LOG_ALWAYS ,NULL},
	{ "allow", do_allow, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "arrest", do_arrest, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	{ "copyover", do_copyover, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "deny", do_deny, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "disconnect", do_disconnect, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	{ "freeze", do_freeze, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	{ "reboo", do_reboo, POS_DEAD,MAX_LEVEL-1, LOG_NORMAL,NULL},
	{ "reboot", do_reboot, POS_DEAD,MAX_LEVEL-1, LOG_ALWAYS,NULL},
	{ "rename", do_rename, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	{ "release", do_release, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	{ "shutdow", do_shutdow, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "shutdown", do_shutdown, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "users", do_users, POS_DEAD,MAX_LEVEL-2,LOG_NORMAL,NULL},
	{ "wizlock", do_wizlock, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "chattoggle", do_chattoggle, POS_DEAD,MAX_LEVEL-2,LOG_ALWAYS,NULL},
	{ "force", do_force, POS_DEAD,MAX_LEVEL-3,LOG_ALWAYS,NULL},
	{ "notell", do_notell, POS_DEAD,MAX_LEVEL-2,LOG_NORMAL,NULL},
	{ "mload", do_mload, POS_DEAD,MAX_LEVEL-3, LOG_ALWAYS,NULL},
	{ "oload", do_oload, POS_DEAD,MAX_LEVEL-3, LOG_ALWAYS,NULL},
	{ "pardon", do_pardon, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	{ "purge", do_purge, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "restore", do_restore, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "revert", do_revert, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "silence", do_silence, POS_DEAD,MAX_LEVEL-2, LOG_NORMAL,NULL},
	{ "sla", do_sla, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	/* cant find godskills.h so commenting out... Ken
	{ "smite", do_smite, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "dog", do_dog, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "outlaw", do_outlaw, POS_DEAD,97, LOG_ALWAYS,NULL},
	*/
	{ "objectdump", do_objectdump, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "slay", do_slay, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "slaughter", do_slaughter, POS_DEAD,MAX_LEVEL-2, LOG_NORMAL,NULL},
	{ "sset", do_sset, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "transfer", do_transfer, POS_DEAD,MAX_LEVEL-3, LOG_ALWAYS,NULL},
	{ "retran", do_retran, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	{ "at", do_at, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "attack", do_attack, POS_STANDING, 0, LOG_NORMAL ,NULL},
	{ "bamfin", do_bamfin, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "bamfout", do_bamfout, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "echo", do_echo, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "holylight", do_holylight, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "timemode", do_timemode, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "maze", do_maze, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "giveprac", do_giveprac, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "download", do_download, POS_DEAD,0, LOG_NORMAL,NULL},
	{ "external", do_external, POS_DEAD,0, LOG_NORMAL,NULL},
	{ "pquit", do_pquit, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	{ "pload", do_pload, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	...
	{ "llog", do_llog, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "listen", do_listen, POS_DEAD, MAX_LEVEL-3, LOG_NORMAL, NULL},
	{ "immclantalk", do_immclantalk, POS_DEAD, MAX_LEVEL-3, LOG_NORMAL, NULL},
	{ "code", do_version, POS_DEAD,0, LOG_NORMAL,NULL},
	{ "version", do_version, POS_DEAD,0, LOG_NORMAL,NULL},
	...
	{ "reign", do_reign, POS_STANDING,MAX_LEVEL, LOG_NORMAL,NULL},
	...
	{ "mprogram", do_mprogram, POS_DEAD,MAX_LEVEL-3,LOG_NORMAL,NULL},
	{ "oprogram", do_oprogram, POS_DEAD,MAX_LEVEL-3,LOG_NORMAL,NULL},
	{ "shutoff", do_shutoff, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "undeny", do_undeny, POS_DEAD,MAX_LEVEL-1, LOG_ALWAYS,NULL},
	{ "fixpass", do_fixpass, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	{ "test1", do_test1, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "test2", do_test2, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "invis", do_invis, POS_DEAD,MAX_LEVEL-2, LOG_NORMAL,NULL},
	{ "log", do_log, POS_DEAD,MAX_LEVEL-2, LOG_ALWAYS,NULL},
	{ "memory", do_memory, POS_DEAD, MAX_LEVEL, LOG_NORMAL,NULL},
	{ "cpu", do_cpu, POS_DEAD, MAX_LEVEL, LOG_NORMAL,NULL},
	...
	{ "mfind", do_mfind, POS_DEAD,MAX_LEVEL-3,LOG_NORMAL,NULL},
	{ "mstat", do_mstat, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "mlist", do_mlist, POS_DEAD,MAX_LEVEL-3,LOG_NORMAL,NULL},
	{ "mwhere", do_mwhere, POS_DEAD,MAX_LEVEL-3,LOG_NORMAL,NULL},
	{ "owhere", do_owhere, POS_DEAD,MAX_LEVEL-3,LOG_NORMAL,NULL},
	{ "ofind", do_ofind, POS_DEAD,MAX_LEVEL-3,LOG_NORMAL,NULL},
	{ "ostat", do_ostat, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "olist", do_olist, POS_DEAD,MAX_LEVEL-3,LOG_NORMAL,NULL},
	{ "peace", do_peace, POS_DEAD,MAX_LEVEL-3,LOG_NORMAL,NULL},
	{ "recho", do_recho, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "return", do_return, POS_DEAD,1, LOG_NORMAL,NULL},
	{ "rstat", do_rstat, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "slookup", do_slookup, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "snoop", do_snoop, POS_DEAD,MAX_LEVEL-2,LOG_NORMAL,NULL},
	...
	{ "termlist", do_termlist, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "delcastle", do_delcastle, POS_DEAD,MAX_LEVEL-1, LOG_NORMAL,NULL},
	{ "hearlog", do_hearlog, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},

#ifndef CODER_EDITION
	/* Clan commands 4/12/98 Martin */

	{ "clans", do_clans, POS_DEAD, 0, LOG_NORMAL ,NULL},
	{ "orders", do_orders, POS_DEAD, 0, LOG_NORMAL ,NULL},
	{ "clanarmy", do_clanarmy, POS_DEAD, 0, LOG_NORMAL,NULL},
	{ "clantalk", do_clantalk, POS_SLEEPING, 0, LOG_NORMAL, NULL},
	{ "ct", do_clantalk, POS_DEAD, 0, LOG_NORMAL, NULL},
	{ ":", do_clantalk, POS_DEAD, 0, LOG_NORMAL, NULL},
	...
	{ "gohome", do_gohome, POS_RESTING, 0, LOG_NORMAL ,NULL},
	{ "makeclan", do_makeclan, POS_RESTING, 50, LOG_ALWAYS ,NULL},
	{ "setclan", do_setclan, POS_RESTING, 0, LOG_ALWAYS ,NULL},
	{ "coffer", do_coffer, POS_RESTING, 10, LOG_ALWAYS ,NULL},
	{ "pledge", do_pledge, POS_RESTING, 10, LOG_NORMAL ,NULL},
	{ "clanwhere", do_clanwhere, POS_RESTING, 0, LOG_NORMAL ,NULL},
	{ "clanlist", do_clanlist, POS_RESTING, 97, LOG_NORMAL ,NULL},
	{ "forceren", do_forceren, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "forcerent", do_forcerent, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "renounce", do_renounce, POS_RESTING, 10, LOG_NORMAL ,NULL},
	{ "nominate", do_nominate, POS_RESTING, 10, LOG_NORMAL ,NULL},
	{ "destroyclan", do_destroy_clan, POS_RESTING, MAX_LEVEL-1,LOG_ALWAYS ,NULL},
	{ "donate", do_donate, POS_STANDING, 10,LOG_NORMAL ,NULL},
	{ "heal", do_heal, POS_DEAD, 10, LOG_NORMAL ,NULL},
#endif
	...
	{ "mcreate", do_mcreate, POS_RESTING, MAX_LEVEL, LOG_NORMAL ,NULL},
	{ "ocreate", do_ocreate, POS_RESTING, MAX_LEVEL, LOG_NORMAL ,NULL},
	{ "mdelete", do_mdelete, POS_RESTING, MAX_LEVEL, LOG_NORMAL ,NULL},
	{ "odelete", do_odelete, POS_RESTING, MAX_LEVEL, LOG_NORMAL ,NULL},
	{ "massign", do_massign, POS_RESTING, MAX_LEVEL, LOG_NORMAL ,NULL},
	{ "oassign", do_oassign, POS_RESTING, MAX_LEVEL, LOG_NORMAL ,NULL},
	{ "rassign", do_rassign, POS_RESTING, MAX_LEVEL, LOG_NORMAL ,NULL},
	*/

	{ "mset", do_mset, POS_DEAD, MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "oset", do_oset, POS_DEAD, MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "rset", do_rset, POS_DEAD, MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "door", do_door, POS_DEAD, MAX_LEVEL, LOG_NORMAL,NULL},
	{ "doorset", do_door, POS_DEAD, MAX_LEVEL, LOG_NORMAL,NULL},
	{ "goto", do_goto, POS_DEAD, MAX_LEVEL-3, LOG_NORMAL,NULL},
	{ "regoto", do_regoto, POS_DEAD, MAX_LEVEL-3, LOG_NORMAL,NULL},

	{ "aset", do_aset, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "astat", do_astat, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},

	/*
	{ "medit", do_medit, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "oedit", do_oedit, POS_DEAD,MAX_LEVEL, LOG_ALWAYS,NULL},
	{ "redit", do_redit, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "hedit", do_hedit, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "mpedit", do_mpedit, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "reset", do_reset, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	{ "rreset", do_rreset, POS_DEAD,MAX_LEVEL, LOG_NORMAL,NULL},
	*/

	{ "resetarea", do_resetarea, POS_DEAD,MAX_LEVEL-3, LOG_NORMAL,NULL},
...

	{
...

		{
...

			{
				...
				{
					"beat",
						"You pound your chest with your fists.",
						"$n mimes fighting someone.",
						"You beat $m senseless. That'll teach $m.",
						"$n starts methodically beating $n senseless.",
						"The world spins as $n starts beating in your face.",
						"You punch your head as hard as you can over and over.",
						"$n beats $mself senseless."
				},

				{
...

					{
...

						{
							...
							{
								"bonk",
									"You raise your fist threateningly.",
									"$n raises $s fist and threatens a bonking.",
									"You bonk $M on the head.",
									"$n bonks $N on the head.",
									"$n bonks you on the forehead.",
									"You bonk yourself on the forehead.",
									"$n bonks $sself on the head."
							},
...

																				{
...

																					{
																						"eyebrow",
																							...
																							"$n arches an eyebrow.",
																							"You arch your eyebrow toward $M speculatively.",
																							"$n arches $s eyebrow toward $N speculatively.",
																							"$n arches $s eyebrow toward you speculatively.",
...

																					{
...

																						{
...

																							{
																								...
																								{
																									"froth",
																										"You slaver and foam at the mouth.",
																										"$n froths at the mouth.",
																										"You snarl and spit froth and drool towards $M.",
																										"$n froths rabidly towards $N.",
																										"$n gives you a funny look and starts foaming at the mouth.",
																										"You froth and drool all over yourself.",
																										"$n froths all over $sself."
																								},
...

																																{
...

																																	{
...

																																		{
																																			"hiss",
																																				"You hiss.",
																																				"$n hisses loudly at the room.",
																																				"You hiss at $M spitefully.",
																																				"$n hisses at $N spitefully.",
																																				"$n hisses at you spitefully.",
																																				"You hiss at yourself in frustration.",
																																				"$n hisses at $sself in frustration."
																																		},

																																		{
																																			...
																																			{
																																				"howl",
																																					"You tilt your head back and howl at the moon.",
																																					"$n tilts $s head back and howls at the moon.",
																																					"You throw back your head and howl bestially at $M.",
																																					"$n howls bestially in response to $N.",
																																					"$n throws back $s head and howls at you.",
																																					"You howl a sad lament to yourself",
																																					"$n howls sadly at $s fate."
																																			},
...

																																										{
...

																																											{
...

																																												{
																																													...
																																													{
																																														"pee",
																																															"You pee all over the place.",
																																															"$n pees all over, like a big dog.",
																																															"You pee all over $N's shoes.",
																																															"$n attacks $N with a spray of urine.",
																																															"$n pees all over your feet and legs.",
																																															"You let loose with a sigh of happiness.",
																																															"$n pees into the wind, drenching $mself."
																																													},
...

																																																			{
...

																																																				{
...

																																																					{
																																																						...
																																																						{
																																																							"salute",
																																																								"You give the room a smart salute.",
																																																								"$n snaps to attention and salutes.",
																																																								"You give a sharp salute to $M.",
																																																								"$n snaps a salute at $N.",
																																																								"$n snaps to attention and salutes you.",
																																																								"You give yourself a mocking salute.",
																																																								"$n gives $sself a mocking salute."
																																																						},
...

																																																							{
...

																																																								{
																																																									...
																																																									/* Removing SING social for SING command - Emperor 11/12/99
																																																									...
																																																									*/
...

																																																										{
...

																																																											{
																																																												...
																																																												{
																																																													"smooch",
																																																														"You make kissey noises.",
																																																														"$n puckers $s lips and makes kissey noises.",
																																																														"You pucker your lips and give $M a smooch.",
																																																														"$n gives $N a big wet smooch.",
																																																														"$n lays a big wet smooch on you.",
																																																														"Which part?",
...

																																																																			{
...

																																																																				{
																																																																					"swoon",
																																																																						...
																																																																						"$n puts $s hand to $s head and swoons.",
																																																																						"You swoon at the sight of $m.",
																																																																						"$n swoons at the sight of $M.",
																																																																						"$n swoons in response to you.",
																																																																						"Well, somebody has to.",
																																																																						"$n looks at $mself and swoons."
																																																																				},

																																																																				{
																																																																					"tackle",
																																																																						"You run around looking for someone to tackle.",
																																																																						"$n lunges at no one in particular.",
																																																																						"You run into $m, taking him down!",
																																																																						"$n leaps on $N's back, tackling them.",
																																																																						"$n vaults onto your back and tackles you.",
																																																																						"You try to get yourself into a headlock and fall down.",
																																																																						"$n knocks $mself down with a surprise attack."
																																																																				},
...

																																																																										{
...

																																																																											{
																																																																												"flutter",
																																																																													...
																																																																													"$n flutters their eyelashes.",
																																																																													"You flutter your eyelashes at $M.",
																																																																													"$n flutters their eyelashes at $N.",
																																																																													"$n flutters $s eyelashes at you.",
																																																																													"You sprain an eye.",
																																																																													"$n blinks furiously at $mself."
																																																																											},
